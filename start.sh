...
urbit -db-location=db4.db -http-addr=127.0.0.5:8080 -config-file=sharding.toml -shard=DB4 &
urbit -db-location=db4-r.db -http-addr=127.0.0.55:8080 -config-file=sharding.toml -shard=DB4 -replica &
